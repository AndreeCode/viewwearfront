...
export default function TryOnPage() {
  ...
  const handleTryOn = async () => {
    ...
    setTimeout(() => {
      setResultImage("/professional-person-full-body-portrait.jpg")
        ...
        <main className="container mx-auto px-4 py-6 md:py-8">
          <div className="flex items-center justify-center gap-2 md:gap-4 mb-6 md:mb-8 overflow-x-auto pb-2">
            <div className="flex items-center gap-1.5 md:gap-2">
              <div
                className={`w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center text-sm md:text-base font-semibold ${
